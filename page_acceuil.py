...
[data-testid="stAppViewContainer"] {
    background: url('https://images.unsplash.com/photo-1600627225432-82de96999068?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
...
if 'averageRating' in df.columns and 'poster_path' in df.columns:
    st.header("⭐ Top 50 Films by Rating ")
